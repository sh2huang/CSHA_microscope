...
from cshascope.lightsheet.state import (
    State,
    get_voxel_size,
    GlobalState,
    LiveCameraState,
...
from cshascope.lightsheet.hardware.cameras.interface import CameraWarning
...
class ViewingWidget(QWidget):
    ...
    def __init__(self, state: State, timer: QTimer, style: str):
        ...
        # setting napari style to lightsheet's
        ...
        # Connect changes of camera to contrast reset:
